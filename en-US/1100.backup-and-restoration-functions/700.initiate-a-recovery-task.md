...
2. Go to the **Initiate Recovery** page by using any of the following methods:
   ...
   * Method 2: Initiate a restore job on the O&M page of a cluster.
     ...
     2. Click the name of the target cluster in **Cluster List** or **Resource Level** to go to its O&M page.
...
5. Select the destination tenant of the restore job. Select a cluster in the Running state from the drop-down list and enter the new tenant name.
   ...
   <main id="notice" type='explain'>
   <h4>Note</h4>
   <p>The following types of clusters cannot be used as the restore destination: <ul><li>Clusters in the primary/standby mode </li><li>Clusters in the Unavailable state </li><li>Clusters of an OceanBase Database version earlier than that of the source cluster </li></ul></p>
   </main>
