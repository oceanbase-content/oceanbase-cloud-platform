...
* [Failed to create the table. Error code: 5360 or ORA-01031](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000001004?back=kb)
* [An error occurred while creating a FOREIGN KEY constraint across user tables in an Oracle tenant of OceanBase Database. Error code: ORA-01031](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000207735) -->
...
* [Error message "ORA-01045 user lacks CREATE SESSION privilege" is returned in OceanBase Database in Oracle mode](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000209983) -->
...
* [An error occurred while modifying the column length in Oracle mode. Error code: ORA-01441](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000207743)
...
* [Error message "ORA-01476: divisor is equal to zero" is returned when the DECODE function contains a UDF](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000209968) -->
...
* Solution: For more information, see [Number format models](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001170247) in SQL Reference (Oracle Mode) on the official website.
