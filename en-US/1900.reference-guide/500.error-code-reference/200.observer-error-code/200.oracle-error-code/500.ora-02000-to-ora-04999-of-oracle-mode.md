...
* [An error occurred while executing the INSERT ALL INTO statement in Oracle mode. Error code: ORA-02291](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000429362?back=kb) -->
...
* [An error occurred while querying a view that is successfully created in an Oracle tenant in OceanBase Database. Error code: ORA-04063](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000207732)
* [An error occurred while using the desc command to show the fields of a view that references a DBLink table. Error code: ORA-04063](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000043619) -->
