...
* [Error message "ORA-12899: value too large for column" is returned when virtual columns are used in an Oracle tenant](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000298689)
