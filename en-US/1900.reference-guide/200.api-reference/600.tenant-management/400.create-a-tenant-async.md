...
| whitelist | String | No | % | The whitelist of the tenant. Supported formats: <li>IP address, for example: xxx.xxx.xxx.1,xxx.xxx.xxx.2 </li><li>Subnet/Mask, for example: xxx.xxx.xxx.3/24 </li><li>Fuzzy match, for example: 10.10.10.% or 10.10.10._</li><li>Mixed format, for example: xxx.xxx.xxx.1,xxx.xxx.xxx.2,10.10.10.%,10.10.10._,xxx.xxx.xxx.3/24 </li><blockquote>**Note**</br>% indicates that all clients can connect to this tenant. Default value: %.</blockquote> |
