...
| \|----restoreClusterId             | Long           | Yes      | The ID of the recovered cluster.                                                                                                                                              |
| \|----obBackupStorageBaseInfo      | Object         | Yes      | The storage information of the backup. For more information, see the data structure in [Create a backup strategy for a cluster](200.create-a-backup-policy-for-the-cluster-1.md). |
