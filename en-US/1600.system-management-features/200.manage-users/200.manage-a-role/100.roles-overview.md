...
Choose **System Management \> User Management** . You can view all [OCP default roles](700.ocp-default-roles.md) of OCP and their respective permissions on the **Role** tab.
