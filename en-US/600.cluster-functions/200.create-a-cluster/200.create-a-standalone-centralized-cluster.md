...
5. Enable **Parameter Settings** and specify related cluster parameters.
...
6. Enable **Custom Settings** to configure paths and ports.
...
8. Confirm the information in the right-side panel, and click **OK**.

9. In the **Note** dialog box, specify whether to create a user tenant.
