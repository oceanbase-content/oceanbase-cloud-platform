...
On the overview page of a cluster, you can view the basic information of the cluster in the following fields: **Cluster Type, Cluster ID, Cluster Type, OceanBase version number, CPU Overallocation Quota, Regions, Deployment Mode, CPU Architecture, Servers, Partitions, Tenants, Created By, OBProxy Cluster, Log Transfer Mode, Synchronization Status, Protection Mode, Software Installation Path, Data Disk Path, Log Disk Path**, **ConfigUrl**, and **Tag**.

![Image 102](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/ocp/422-en/%E9%9B%86%E7%BE%A4%E4%BF%A1%E6%81%AF1.png)

| Parameter | Description |
|------------|---|
| Cluster Name | The name of the cluster. You can click the **Copy** icon next to the cluster name to copy it.  |
| Cluster ID | The unique ID of the cluster that is automatically generated when it was created.  |
...
| Data Disk Path | The software installation path specified when the cluster was created.  |
| Log Disk Path | The software installation path specified when the cluster was created.  |
...
<h4>Note</h4>
<p><li>If CPU overprovisioning is enabled for the cluster, the maximum and minimum numbers of allocated CPU cores are displayed in the **Resource Usage** section. </li><li>If the cluster version is earlier than OceanBase Database V4.0, the <b>Allocated Log Disk</b> information is not displayed in the <b>Resource Usage</b> section. </li></p>
</main>
...
* The **Actions** column provides the following options: **Restart, Stop Service, Stop Process, Reinstall, Replace, Delete**, and **Download Logs**. For more information, see [Restart a faulty OBServer node](../600.manage-an-observer/200.restart-observer.md), [Stop an OBServer service](../600.manage-an-observer/300.stop-observer-service.md), [Stop the observer process](../600.manage-an-observer/400.stop-observer-process.md), [Reinstall an OBServer](../600.manage-an-observer/600.reinstall-observer.md), [Replace an OBServer node](../600.manage-an-observer/500.replace-observer.md), [Delete an OBServer](../600.manage-an-observer/700.delete-observer.md), and [Download logs](../../1300.log-service/200.download-log.md).

<main id="notice" type='explain'>
<h4>Note</h4>
<p><li>If CPU overprovisioning is enabled for the cluster, the maximum and minimum numbers of allocated CPU cores are displayed in the <b>Resource Usage</b> section. </li><li>The <b>Log Disk</b> data is displayed in the <b>Resource Usage</b> section only for a cluster of OceanBase Database V4.0 or later. </li></p>
</main>
...
You can perform basic cluster management operations on the **Overview** page of a cluster. For more information, see [Add an OBServer node](../600.manage-an-observer/100.add-an-observer.md), [Add a zone](../500.manage-a-zone/100.create-a-zone.md), [Create a tenant](../../500.quickstart/600.quickstart-create-a-tenant.md), [Create a standby cluster](../300.manage-a-cluster/100.create-a-standby-cluster.md), [Upgrade a cluster](../700.upgrade-cluster-version.md), [Change the password of the sys tenant](../300.manage-a-cluster/900.change-password.md), [Restart a cluster](../300.manage-a-cluster/500.restart-a-cluster.md), [Stop a cluster](../300.manage-a-cluster/600.stop-a-cluster.md), [Delete a cluster](../300.manage-a-cluster/700.delete-a-cluster.md), [Decouple a standby cluster from the primary cluster](../../1200.manage-disaster-recovery/200.switching-primary-and-standby-databases/300.decoupling-cluster.md), [Enable automatic detection of deadlocks](../300.manage-a-cluster/1000.enable-automatic-deadlock-detection.md), [Disable automatic detection of deadlocks](../300.manage-a-cluster/1100.disable-automatic-detection-of-deadlocks.md), [Download logs](../../1300.log-service/200.download-log.md), [Disable SQL collection](../300.manage-a-cluster/1200.disable-sql-collection.md), and [View the SQL collection history](../300.manage-a-cluster/1300.view-the-sql-collection-switch-history.md).
