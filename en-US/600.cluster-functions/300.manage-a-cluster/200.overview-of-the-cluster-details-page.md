...
| Cluster ID | A unique cluster ID that is automatically generated when the cluster is created. |
...
In the OBServer node list, you can view the following OBServer node parameters: **IP, SQL Port, RPC Port, Zone, Host Type, Resource Usage (CPU, Memory, and Data disk)**, and **Status**.
