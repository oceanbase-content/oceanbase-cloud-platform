...
You can perform basic cluster management operations on the **Overview** page of a cluster. For more information, see [Add an OBServer node](../600.manage-an-observer/100.add-an-observer.md), [Add a zone](../500.manage-a-zone/100.create-a-zone.md), [Create a tenant](../../500.quickstart/600.quickstart-create-a-tenant.md), [Create a standby cluster](100.create-a-standby-cluster.md), [Upgrade a cluster](../700.upgrade-cluster-version.md), [Change the password of the sys tenant](800.change-password.md), [Restart a cluster](500.restart-a-cluster.md), [Stop a cluster](600.stop-a-cluster.md), [Delete a cluster](700.delete-a-cluster.md), [Decouple a standby cluster from the primary cluster](../../1200.manage-disaster-recovery/200.switching-primary-and-standby-databases/300.decoupling-cluster.md), [Enable automatic detection of deadlocks](900.enable-automatic-deadlock-detection.md), [Disable automatic detection of deadlocks](1000.disable-automatic-detection-of-deadlocks.md) and [Download logs](../../1300.log-service/200.download-log.md).
