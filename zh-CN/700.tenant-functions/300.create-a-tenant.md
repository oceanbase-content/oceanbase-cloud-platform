...
* （可选）已参考 [租户参数模板管理](1700.manage-tenant-parameter-templates.md) 创建好参数模板。
...
7. 打开 **参数配置** 模块，并配置租户参数。
    ...
    * 也可通过如图 ② 处，单击 **选择参数模板**，选择一个参数模板，系统会将模板中的参数连同配置自动填充到此处。在未创建租户参数模板的情况下，您可单击 **新建租户模板**，为租户创建参数模板，详情可参考 [租户参数模板管理](1700.manage-tenant-parameter-templates.md)。
