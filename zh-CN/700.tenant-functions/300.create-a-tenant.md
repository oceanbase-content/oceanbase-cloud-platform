...
4. 填写 **基本设置** 。需要完成的基本设置及其相关说明如下表所示。
   ...
   | **服务名** | 可选。当 OceanBase 集群为 V4.2.4 及之后版本时可用。服务名是 OceanBase 提供的一种新的数据库访问方式，可以视其为集群名和租户名的别名，实现应用程序通过服务名的方式访问数据库。服务名以英文字母或者下划线开头，可包含英文、数字和下划线，且长度为 2\~64 个字符。 |
   | **备注**        | 可选，备注说明信息。 |

   ![10](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/ocp/431/%E5%9F%BA%E6%9C%AC%E8%AE%BE%E7%BD%AE.png)
