...
4. 填写 **基本设置** 。需要完成的基本设置及其相关说明如下表所示。
   ...
   | **服务名** | 可选。服务名是 OceanBase 提供的一种新的数据库访问方式，可以视其为集群名和租户名的别名，实现应用程序通过服务名的方式访问数据库。服务名以英文字母开头，可包含英文、数字和下划线，且长度为 2\~64 个字符。当满足如下版本要求时，方可为租户配置服务名：<ul><li>所属集群为 V4.2.4 及以上、V4.3.0 以下版本。</li><li>OBProxy 为 V4.3.1 及以上版本。</li></ul> |
   | **备注**        | 可选，备注说明信息。 |
