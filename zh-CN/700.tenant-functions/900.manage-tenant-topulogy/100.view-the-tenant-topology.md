...
* Zone 上存在副本分布
  ...
  * 单击 Zone 图标右侧的操作按钮，可打开操作列表。
    ...
    * 单击 **修改副本类型** ，会弹出如下窗口，可对副本类型进行修改。
      ...
      <main id="notice" type='explain'>
      <h4>说明</h4>
      <p><ul><li>当副本类型为 <b>只读列存型副本</b> 时，不支持修改为其他副本类型。</li><li>当副本类型为 <b>全能型副本</b> 或 <b>日志型副本</b> 时，不支持修改为 <b>只读列存型副本</b>。</li><li>更多信息，请参见 <a href="../300.create-a-tenant.md">新建租户</a> 中的副本类型说明。</li></ul></p>
      </main>
