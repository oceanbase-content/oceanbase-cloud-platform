...
| Cgroup 配置    | 显示当前集群是否开启 Cgroup。单击编辑按钮，可进行关闭或开启操作。<main id="notice" type='explain'><h4>说明</h4><p><ul><li>若您的业务场景为单租户、小规格（<14C）以及需要更高的数据库性能时，建议您关闭 Cgroup。</li><li>若主机上的操作系统内核版本低于 4.1.9，集群将无法创建租户，此时系统将默认关闭 Cgroup 且不显示 Cgroup 开关。</li><li>开启 Cgroup 将会重启集群，请谨慎操作。</li></ul></p></main>  |
