...
| serverId   | Integer  | 否  | 300                       | 查询在指定 OceanBase 服务器上执行的 SQL。不指定时，查询在所有 OceanBase 服务器上执行的 SQL。                                                                                                                                                                                                                                                                                                                               |
| inner      | Boolean  | 否  | false                     | 是否包含内部 SQL。内部 SQL 是指由 OceanBase 发起的 SQL。 * 默认为 false，即不包含内部 SQL。                                                                                                                                                                                                                                                   |
...
* SQL 性能指标的数据结构
  ...
  | server                      | String  | OceanBase 服务器的地址。                                                                                                                                                                                                                                                                                                                                                                                               |
  ...
  | avgApplicationWaitTime          | Float   | SQL在期间内的平均Application事件等待时间（毫秒）。                                                                                                                                                                                                                                                                                                                                                                         |
