...
7. 打开 **自定义设置**，对集群端口、操作系统所属主用户及路径进行配置。
   ...
   | **操作系统所属主用户**     | 用于配置安装、运行 OBServer 的操作系统用户，不支持编辑，可通过 [修改系统参数](../1600.system-management-features/500.manage-system-parameter/200.modify-system-parameters.md) `ocp.operation.default.os.user` 调整默认配置。用户修改后，仅对 [创建分布式集群](../600.cluster-functions/200.create-a-cluster/100.create-a-distributed-cluster.md)、创建 OBProxy 集群和 [创建仲裁服务](../600.cluster-functions/400.manage-arbitration-services/200.create-arbitration-services.md) 产生影响，不影响已有集群的其他配置。  |
