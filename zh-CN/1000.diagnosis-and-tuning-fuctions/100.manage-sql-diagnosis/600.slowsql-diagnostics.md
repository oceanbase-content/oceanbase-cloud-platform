...
* 默认配置下，执行时间超过 100ms 的为 SlowSQL。您可在 **集群** > **运维配置** > **SQL 诊断采集** 中找到参数 **monagent.ob.slow.sql.threshold** ，通过该参数修改 SlowSQL 判定的默认阈值，详情可参考 [管理参数](../../600.cluster-functions/300.manage-a-cluster/1200.manage-om-configuration/200.manage-om-configuration-parameters.md)。
