...
| net.ipv4.ip_local_port_range | 3500 ≤ value ≤ 65535 | 该参数控制可用的本地端口号范围，建议范围 3500~65535。 |
| net.ipv4.ip_local_reserved_ports | 62881 ≤ value ≤ 63881 | 该参数用来保留设置端口号列表号不被系统自动分配，检查是否预留 62881~63881 范围的端口，确保 ocp-agent 需要使用这个范围的端口号提供运维监控等服务。 |
...
检查默认网卡 MTU 值，建议值为 1500，过大或过小不会影响系统运行，但会对网络传输效率、性能产生影响。
